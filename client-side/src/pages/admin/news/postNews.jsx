...
import { newsPost } from "../../../../libs/news.js";
// import { postValidate } from "../../../../libs/newsValidate/newsValidate.js";
const postNews = () => {
    ...
    const handleSubmit = () => {
        ...
        const confirmOption = confirm("lanjutkan post news??");
        if (confirmOption) {
            newsPost(values).then(resp => {
    ...
    return (
        <div className="px-6 pt-8">
            ...
            <button
                type="button"
                class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-400 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
